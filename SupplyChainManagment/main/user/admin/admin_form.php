...
if(isset($_POST['add'])) {
	  ...
	  $pass=$_POST['pwd'];
	  $sql="insert into admin_login values(null,'$cat_name','$pass')";
		  ...
		  <form action="" method="POST" enctype="multipart/form-data">
              <div class="box-body">
               <!--- <div class="form-group">
				...
				<div class="form-group">
                  <label for="cat_img">Admin Email</label>
                  <input type="text" class="form-control" name="email" id="" placeholder="Enter email">
				  <label for="cat_img">Password</label>
                  <input type="text" class="form-control" name="pwd" id="" placeholder="password">
                </div>

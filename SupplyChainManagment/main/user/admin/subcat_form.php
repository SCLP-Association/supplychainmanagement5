...
if(isset($_POST['add'])) 
{
	  ...
	  echo $cat_name;
	  $sql="insert into sub_cat_table(cid,sub_cat_name) values('$cat_name','$subcat_name')";
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="subcat_view.php">Sub-Catagory</a></li>
...
<?php 
	  ...
	  {
	  ?>
	  <input type="text" value="<?php echo $row2['cid'];?>"><?php echo $row2['cat_name'];?></input>
	  <?php
	  }
	  ?>-->

...
$cat_id=$_GET['id'];
$sql="select * from sub_cat_table where id='$cat_id'";
...
if(isset($_POST['add'])) {
	  ...
	  $query="update sub_cat_table set cid='$flash',sub_cat_name='$flash1' where id='$cat_id1'";
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="col-xs-12">
          <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Edit Sub-Catagory</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
		  ...
		  <form action="" method="POST" enctype="multipart/form-data">
              <div class="box-body">
               <!--- <div class="form-group">
				...
				<input type="hidden" name="id11" id="" value="<?php echo $row['id'];  ?>">
				<div class="form-group">
	...
	<div class="form-group">
                  <label for="cat_img">Sub-Catagory Name</label>
                  <input type="text" class="form-control" name="flash1" id="" value="<?php echo $row['sub_cat_name'];  ?>">
                </div>
						<?php  }  ?>

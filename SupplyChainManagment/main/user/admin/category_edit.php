...
$cat_id=$_GET['id'];
$sql="select * from cat_table where cid='$cat_id'";
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="category_view.php">Catagory</a></li>
		  ...
		  <form action="" method="POST" enctype="multipart/form-data">
              <div class="box-body">
               <!--- <div class="form-group">
				...
				<input type="hidden" name="id11" id="" value="<?php echo $row['cid'];  ?>">
				<div class="form-group">
                  <label for="cat_img">Catagory Name</label>
                  <input type="text" class="form-control" name="flash" id="" value="<?php echo $row['cat_name'];  ?>" >
                </div>

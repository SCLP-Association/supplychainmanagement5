...
$sql = 'SELECT * FROM vendor_request ORDER BY vid';
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Vendor Request</li>
      </ol>
    </section>
...
<th>Processed</th>
              ...
              <td><?php echo $row['phone']; ?></td>
                  ...
                  <td>   
                  <a href="vendor_process.php?id=<?php echo $row['vid'];   ?>" class="btn btn-app-min">
                  <i class="fa fa-edit"></i> Processed
              	  </a></td>
				  <td>
                  <a href="vendor_delete.php?id=<?php echo $row['vid'];   ?>" class="btn btn-app-min">

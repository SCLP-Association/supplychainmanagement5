...
if(isset($_POST['add']))
 {
	  ...
	  $cat_name=$_POST['email'];
	  $sql="insert into quantity(qty_no) values('$cat_name')";
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="quantity_view.php">Quantity View</a></li>
        <li class="active">Add Quantity</li>
      </ol>
    </section>
              ...
              <div class="box-body">
               <!--- <div class="form-group">
				...
				<div class="form-group">
                  ...
                  <input type="text" class="form-control" name="email" id="" placeholder="Enter here">
                </div>
				
				<!---<div class="form-group">
                  <label for="cat_title">From Date :</label>
                  <input type="date" class="form-control" name="from"  id="catagory_title" placeholder="Catagory Name">
                </div>

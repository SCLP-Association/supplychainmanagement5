...
$sql = "SELECT * FROM march_recived where cvid='$current_vendor'";
              ...
              <table class="table table-bordered">
               ...
               <tr>
				...
				<!--  <td><?php echo $row['cvid']; ?></td> -->
                  ...
                  <td>
                  <a href="enquiry_replied_update.php?id=<?php echo $row['recieve_id'];   ?>" class="btn btn-app-mini">
                  <i class="fa fa-edit"></i><?php echo $row['status']; ?>
                  </a>
				  </td>

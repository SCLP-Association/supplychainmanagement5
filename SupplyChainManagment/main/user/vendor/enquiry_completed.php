...
$sql = "SELECT * FROM march_completed mc,vendor_confirm vc where mc.cvid = vc.cvid and mc.cvid='$current_vendor'";
...
<div class="wrapper">
  ...
  <div class="row" style=" opacity: 0.9;">
      ...
      <div class="col-xs-12 col-md-4">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <strong><i class="fa  fa-user margin-r-5"></i>Merchant Name: &nbsp; <?php echo $row['mname']; ?></strong>
      ...
      <strong><i class="fa fa-book margin-r-5"></i>Merchant ID: &nbsp; <?php echo $row['mid']; ?></strong>
        ...
        <hr>
              ...
              <strong><i class="fa fa-rupee margin-r-5"></i> PRICE</strong>
        ...
        <hr>
              ...
              <strong><i class="fa   fa-commenting-o margin-r-5"></i> Description</strong>
        ...
        <button class="btn btn-primary" name="invoice" value=""><b>COMPLETED</b></button>
        </div>

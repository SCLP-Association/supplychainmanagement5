...
if(isset($_POST['add'])) {
	...
	$del=test_input($_POST['id11']);
	   ...
	   $f5=test_input($_POST['f5']);
	   $f6=test_input($_POST['f6']);
	   $f7=test_input($_POST['f7']);
	   $f8=test_input($_POST['f8']);
	   $f9=test_input($_POST['f9']);
	   $f10=test_input($_POST['f10']);
	   $f11=test_input($_POST['f11']);

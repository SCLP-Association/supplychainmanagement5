...
$sql = "SELECT * FROM march_decline where cvid='$current_vendor' AND v_flag='1'";
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
		...
		<li class="active">Enquiery Decliend</li>
      </ol>
    </section>
	...
	<div class="row" style=" opacity: 0.9;">
			...
			<strong><i class="fa fa-book margin-r-5"></i>Merchant ID: &nbsp; <?php echo $row['mid']; ?></strong>
              ...
              <strong><i class="fa fa-exclamation margin-r-5"></i> Reason</strong>
			  ...
			  <a href="enquiry_decline_remove.php?id=<?php echo $row['decline_id'];   ?>" class="btn btn-danger btn-block"><b>Remove</b></a>
			  </div>
			  </div>
            </div>

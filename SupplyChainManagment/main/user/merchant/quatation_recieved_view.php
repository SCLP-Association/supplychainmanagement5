...
$sql = "SELECT * FROM march_recived where mid='$current_vendor'";
  ...
  <div class="content-wrapper">
    ...
    <div class="pull-right hidden-xs">
          ...
          <div class="box box-success">
           ...
           {
            ?>
            <td class="btn btn-danger "><?php echo $row['status']; ?></td>
            <?php
           }
           else
           {
            ?>
            <td class="btn btn-warning "><?php echo $row['status']; ?></td>
            <?php

...
$sql = "SELECT * FROM march_decline a,vendor_confirm b where a.mid='$current_vendor' AND a.cvid=b.cvid AND m_flag='1'";
...
<div class="wrapper">
  ...
  <section class="content">
	...
	<div class="row" style=" opacity: 0.9;">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <strong><i class="fa fa-user margin-r-5"></i>Vendor Name: &nbsp; <?php echo $row['name']; ?></strong>
			...
			<strong><i class="fa fa-book margin-r-5"></i>Vendor ID: &nbsp; <?php echo $row['cvid']; ?></strong>
              ...
              <strong><i class="fa  fa-balance-scale margin-r-5"></i> Quantity</strong>
				
              <p class="text-muted"><?php echo $row['qty_id'];?> &nbsp; <?php echo $row['uiid'];?></p>

              <hr>

              <strong><i class="fa fa-bookmark-o margin-r-5"></i> Description</strong>
              ...
              <strong><i class="fa fa-warning margin-r-5"></i> Reason</strong>
			  ...
			  <a href="quatation_decline_remove.php?id=<?php echo $row['decline_id'];   ?>" class="btn btn-danger btn-block"><b>Remove</b></a>
			  </div>
			  </div>
            </div>

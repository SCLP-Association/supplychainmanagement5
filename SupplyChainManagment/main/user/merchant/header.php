            ...
            <ul class="dropdown-menu" style="box-shadow: 0 8px 12px 3px #888888;">
              ...
              <li class="user-header">
                ...
                <p>
                  ...
                  <small>YOUR ID IS  <?php  echo $_SESSION['mid']; ?></small>
                </p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="main_home.php" class="btn btn-primary ">Profile</a>
                </div>
...
<li class="treeview">
          <a href="#">
            <i class="fa fa-circle-o-notch"></i> <span><?php echo $catrow['cat_name']; $temp=$catrow['cid'];?></span>
		...
		<li>
          <a href="quatation_sent_view.php">
            <i class="fa  fa-check-square-o"></i> <span>Sent Quatation</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
		...
		<li>
          <a href="quatation_recieved_view.php">
            <i class="fa fa-check-square"></i> <span>Accepted Quatation</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
        ...
        <li>
          <a href="quatation_completed.php">
            <i class="fa  fa-check"></i> <span>Completed Quatation</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
		...
		<li>
          <a href="quatation_decline_view.php">
            <i class="fa  fa-close"></i> <span>Decline Quatation</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>

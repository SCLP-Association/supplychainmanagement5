...
$cat_id=$_GET['id'];
$sql="select * from march_register where mid='$cat_id'";
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
              ...
              <div class="box-body" style="box-shadow: 0 8px 12px 1px #888888;">
               <!--- <div class="form-group">
				...
				<div class="form-group">
                  ...
                  <input type="text" class="form-control"  name="f1" id="" value="<?php echo $row['mname'];  ?>">
                </div>
			

	<div class="form-group">
                  <label for="cat_img">EMAIL</label>
                  <input type="text" class="form-control" readonly="true"   id="" value="<?php echo $row['memail'];  ?>">
                </div>
	...
	<div class="form-group">
                  ...
                  <input type="text" class="form-control" name="f3" id="" value="<?php echo $row['mphone'];  ?>">
                </div>				
	...
	<div class="form-group">
                  ...
                  <input type="text" class="form-control" name="f4" id="" value="<?php echo $row['mcity'];  ?>">
                </div>	

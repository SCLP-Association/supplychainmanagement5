...
if ($_SERVER["REQUEST_METHOD"] == "POST")
{
  ...
  $userpass=$_POST['password'];
	...
	//echo "<h5 style=\"color:white\">SQL INJECTION PREVENTED<h5>";
	...
	if($results=mysqli_fetch_assoc($res))
	{
		...
		if($type=="pro")
		{
			...
			?>
			<script>
				document.location="user/admin/home.php";
			</script>
			<?php
		...
		else if($type=="merchant")
		{
			...
			?>
			<script>
				document.location="user/merchant/main_home.php";
			</script>
			<?php
		}
		else if($type=="vendor")
		{
			...
			?>
			<script>
				document.location="user/vendor/home.php";
			</script>
			<?php
		}
		else if($type=="temp")
		{
			...
			?>
			<script>
				document.location="user/temp/home.php";
			</script>
			<?php
		}
		else
...
<div class="footer-w3l">
	<p>&copy; 2018 UPASTHA. All rights reserved | Design by <a href="#">Indushree </a></p>
</div>
<!-- //footer -->
<!-- js-scripts-->

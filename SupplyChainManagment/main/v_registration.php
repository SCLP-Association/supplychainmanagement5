...
if (isset($_POST['register']))
	{
		...
		if($password==$confirm)
		{
			...
			while($row=mysqli_fetch_assoc($res))
			{
				...
				if($test==0)
				{
					$sql1="insert into getin values(null,'$email','$password','$question','$answer','temp')";
					$res1=mysqli_query($conn,$sql1);
					$sql2="insert into vendor_request values(null,'$name','$email','$mobile','$city','dumpasword')";
